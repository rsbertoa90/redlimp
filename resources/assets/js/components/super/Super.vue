<template>
    ...
    <div class="row mt-4">
        ...
        <div class="col-12 row p-4">
            ...
            <hr>
            <button class="col-12 col-lg-3 btn"
            ...
            <button class="col-12 col-lg-3 btn"
                    :class="{'btn-info':panel=='meta-supercategories',
                            'btn-outline-info':panel!='meta-supercategories'}"
                     @click="panel='meta-supercategories'">
                Supercategorias
            </button>
            <button class="col-12 col-lg-3 btn"
...
<script>
import metaSupercategories from './supercategories.vue';
